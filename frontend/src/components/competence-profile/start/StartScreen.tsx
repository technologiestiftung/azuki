			...
			<div className="flex flex-col h-[100dvh] pt-4 overflow-hidden min-h-0 bg-sky-100">
				<div className="flex-1 flex flex-col items-center justify-center px-4 min-h-0">
					<div
						...
						className={`flex-1 flex justify-center w-full min-h-0 animate-slideInBottom [animation-duration:0.6s] ${isFirstStep ? "items-end" : "items-center"}`}
					>
						{isFirstStep ? (
							<img
				...
				<div
					...
					className="flex flex-col gap-3 pt-6 bg-sky-white rounded-t-4xl animate-slideInBottom [animation-duration:1s]"
				>
					...
					<div className="w-full flex flex-col px-4 pb-4 gap-y-2 max-w-[430px]">
