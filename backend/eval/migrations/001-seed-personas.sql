...
--
-- Active personas (10):
--   nico  — Hauptschule Kfz-dropout
--   elina — Realschule, 2nd-gen Bulgarian, helping+creative
--   karim — refugee from Lebanon, foreign_degree, A2 German
--   mia   — Realschule, sparse text, Salon Praktikum
--   tom   — Realschule, gaming/anime/YouTube hobby
--   hanna — Realschule, dual creative + care clusters
--   noah  — vague aspirational low-signal Joblinge teen
--   amira — Syrian refugee, foreign_degree, B1 German, care direction
--   lukas — Hauptschule, German native, confident Bau-direction
--   lara  — Realschule, 2nd-gen Turkish, confident kaufmännisch-direction
--
-- All tiers Joblinge-recalibrated. Every tier id must exist in
-- backend/src/data/berufe.json — ids the catalog no longer carries can never
-- be returned, so they silently lower the reachable score. §66 BBiG / §42r
-- HwO Fachpraktiker were removed from the catalog wholesale by
-- scripts/apply-joblinge-exclusions.ts and are therefore absent from all
-- tiers. Run `npm run eval:audit-personas` after any catalog refresh.
--
...
--
-- NOTE (Elina Tier C id 34975): the source rubric named "Bauten- und
-- Objektbeschichter", which berufe.json does not carry; it is transcribed as
-- Oberflächenbeschichter/in (34975).


-- ============================================================
-- Persona 1: Nico B.
-- 18, Hauptschulabschluss, dropped Kfz-Mechatroniker after 4 months.
-- tierS: 6  tierA: 14  tierC: 74
-- ============================================================
...
insert into personas (
  ...
  '{
    ...
    "practicalExperiences": [
      {
        "id": "nico-kfz",
        "description": "hab 4 monate kfz-mechatroniker gemacht, war zu hart körperlich und der ton in der werkstatt war nichts für mich. hab aufgehört. will was wo man nicht den ganzen tag nur ackert",
        "selectedExperienceId": "internship",
        "selectedExperienceLabel": "Praktikum",
        "rating": 1
      }
    ],
    "selectedPracticalExperienceIds": ["nico-kfz"],
    "workPreferences": {
      "environment": "a",
      "hands-vs-mind": "a",
      "people": "a",
  ...
  -- tier_s: 6 entries (Elektroniker family)
  ARRAY[
  ...
  -- tier_a: 14 entries (Mechatroniker; noise is its only friction)
  ARRAY[
...
insert into personas (
  ...
  '{
    ...
    "practicalExperiences": [
      {
        "id": "elina-schule",
        "description": "Manchmal helfe ich bei schulischen Projekten aus.",
        "selectedExperienceId": "school",
        "selectedExperienceLabel": "Schule",
        "rating": 4
      },
      {
        "id": "elina-geschwister",
        "description": "Zuhause übernehme ich viel Verantwortung für meine jüngeren Geschwister.",
        "selectedExperienceId": "home-help",
        "selectedExperienceLabel": "Zu Hause",
        "rating": 4
      }
    ],
    "selectedPracticalExperienceIds": ["elina-schule", "elina-geschwister"],
    "workPreferences": {
      "environment": "a",
      "hands-vs-mind": "b",
      "people": "b",
...
insert into personas (
  ...
  '{
    ...
    "practicalExperiences": [
      {
        "id": "karim-kurs",
        "description": "ich haben Integrationskurs gemacht und Sprachkurs",
        "selectedExperienceId": "school",
        "selectedExperienceLabel": "Schule",
        "rating": 4
      },
      {
        "id": "karim-umzug",
        "description": "ich habe geholfen bei Umzug von Freunde, viel Kisten tragen und Möbel aufbauen",
        "selectedExperienceId": "friends",
        "selectedExperienceLabel": "Im Freundeskreis",
        "rating": 4
      }
    ],
    "selectedPracticalExperienceIds": ["karim-kurs", "karim-umzug"],
    "workPreferences": {
      "environment": "a",
      "hands-vs-mind": "a",
      "location": "a",
  ...
  -- tier_s: 5 entries (v3 — demoted Einzelhandel → Tier A; screen-work conflicts with Karim's "computer" no-go)
  ARRAY[
    6628,   -- Verkäufer/in
    27448,  -- Fachkraft - Lagerlogistik
    27539,  -- Fachlagerist/in
  ...
  -- tier_a: 15 entries (v3 — Einzelhandel demoted from S due to computer no-go conflict)
  ARRAY[
...
insert into personas (
  ...
  '{
    ...
    "customStrengths": ["weiß nicht"],
    "selectedCustomStrengths": ["weiß nicht"],
    "preferredJobs": [],
    "customWorkExpectations": [],
    "practicalExperiences": [
      {
        "id": "mia-salon",
        "description": "Praktikum bei meiner Tante im Salon",
        "selectedExperienceId": "internship",
        "selectedExperienceLabel": "Praktikum",
        "rating": 4
      }
    ],
    "selectedPracticalExperienceIds": ["mia-salon"],
    "workPreferences": {
      "environment": "a",
      "hands-vs-mind": "a",
      "people": "b",
  ...
  -- tier_s: 7 entries (v3 — promoted ZFA/Hotelfach/Kosmetiker-schulische from Tier A for 100% reachability)
  ARRAY[
  ...
  -- tier_a: 9 entries (v3 — ZFA/Hotelfach/Kosmetiker-schulische promoted to S)
  ARRAY[
    50920,  -- Fachverkäufer/in - Lebensmittelhandwerk (Bäckerei)
    50922,  -- Fachverkäufer/in - Lebensmittelhandwerk (Konditorei)
    14624,  -- Kosmetiker/in (duale Ausbildung)
  ...
  -- tier_c: 77 entries (noise/dirt/heavy)
  ARRAY[
    ...
    132661, 132660, 139143, 139147, 132659, -- Tiefbaufacharbeiter variants
    3938,   -- Maurer/in
    3980,   -- Beton- und Stahlbetonbauer/in
    129406, -- Dachdecker/in
    4066,   -- Gerüstbauer/in
    ...
    14557, 14326, 14217, 8459, 14319,  -- Designer variants
    6755,   -- Bankkaufmann
...
insert into personas (
  ...
  '{
    ...
    "customStrengths": ["Bin sehr gut in League of Legends, hab Platinum erreicht. Mache YouTube-Videos über Anime und schneide sie selbst."],
    "selectedCustomStrengths": ["Bin sehr gut in League of Legends, hab Platinum erreicht. Mache YouTube-Videos über Anime und schneide sie selbst."],
    "preferredJobs": [],
    "customWorkExpectations": [],
    "practicalExperiences": [
      {
        "id": "tom-supermarkt",
        "description": "Schülerpraktikum im Supermarkt, ging so.",
        "selectedExperienceId": "internship",
        "selectedExperienceLabel": "Praktikum",
        "rating": 2
      }
    ],
    "selectedPracticalExperienceIds": ["tom-supermarkt"],
    "workPreferences": {
      "environment": "a",
      "hands-vs-mind": "b",
      "people": "a",
  ...
  -- tier_s: 5 entries (Joblinge-realistic IT/office/Mediengestalter anchors)
  ARRAY[
  ...
  -- tier_a: 10 entries (Realschule-stretch IT + Mediengestalter siblings)
  ARRAY[
  ...
  -- tier_c: 75 entries (heavy/outdoor)
  ARRAY[
    ...
    132661, 132660, 139143, 139147, 132659,  -- Tiefbau
    ...
    70148,  -- Servicekraft - Schutz und Sicherheit
    9910, 14624, 9929,  -- Friseur/Kosmetiker
    680,  -- Florist
...
insert into personas (
  ...
  '{
    ...
    "customStrengths": ["Ich male und zeichne gerne, tanze in einer Gruppe, mache auch Musik. Außerdem helfe ich oft im Altersheim aus, meine Oma sagt ich bin sehr einfühlsam."],
    "selectedCustomStrengths": ["Ich male und zeichne gerne, tanze in einer Gruppe, mache auch Musik. Außerdem helfe ich oft im Altersheim aus, meine Oma sagt ich bin sehr einfühlsam."],
    "preferredJobs": [],
    "customWorkExpectations": [],
    "practicalExperiences": [
      {
        "id": "hanna-babysitter",
        "description": "Aushilfsjob als Babysitter",
      ...
      {
        "id": "hanna-baecker",
        "description": "Aushilfsjob beim Bäcker",
        "selectedExperienceId": "job",
        "selectedExperienceLabel": "Job",
        "rating": 3
      }
    ],
    "selectedPracticalExperienceIds": ["hanna-babysitter", "hanna-baecker"],
    "workPreferences": {
      "environment": "a",
      "variety": "b",
      "people": "b",
  ...
  -- tier_a: 13 entries (v3 — Krankenpflegehelfer demoted from S due to heavy-work no-go conflict)
  ARRAY[
    137684, -- Mediengestalter/in Digital und Print - Designkonzeption
    137682, -- Mediengestalter/in Digital und Print - Digitalmedien
    6515,   -- Gestaltungstechnische/r Assistent/in
  ...
  ARRAY[
    ...
    13794,  -- Berufskraftfahrer
    34941, 34948, 34943,  -- Industriekeramiker variants
    -- Education / wrong-direction mismatch
    5620, 2874, 6379, 33197,  -- Technische/r Assistent/in variants
    ...
    14319, 14326, 8459, 14557,  -- Designer variants
    5924,   -- Bekleidungstechnische/r Assistent/in
    -- Universal niche bait
    124509, 124510,
    2687, 2665,
...
insert into personas (
  ...
  '{
    ...
    "strengths": {},
    "customStrengths": ["Ich bin freundlich und höre gut zu, kann mich gut anpassen."],
    "selectedCustomStrengths": ["Ich bin freundlich und höre gut zu, kann mich gut anpassen."],
    "preferredJobs": [],
    "customWorkExpectations": [],
    "practicalExperiences": [
      {
        "id": "noah-keine",
        "description": "Will einen guten Job finden, der mich glücklich macht und ordentlich bezahlt. Habe noch keine richtige Erfahrung, bin erst 16.",
        "selectedExperienceId": null,
        "selectedExperienceLabel": null,
        "rating": 3
      }
    ],
    "selectedPracticalExperienceIds": ["noah-keine"],
    "workPreferences": {},
    "noGos": {}
  }'::jsonb,
  ...
  -- tier_a: 5 entries (Realschule-leaning stretches)
  ARRAY[
  ...
  ARRAY[
    ...
    2927,   -- IT-System-Elektroniker
    14557, 14326, 14217, 8459, 14319,  -- Designer
...
insert into personas (
  ...
  '{
    ...
    "customStrengths": ["ich bin sehr geduldig mit Kindern. meine kleine Geschwister sagen ich kann gut erklären wenn sie etwas nicht verstehen"],
    "selectedCustomStrengths": ["ich bin sehr geduldig mit Kindern. meine kleine Geschwister sagen ich kann gut erklären wenn sie etwas nicht verstehen"],
    "preferredJobs": [],
    "customWorkExpectations": [],
    "practicalExperiences": [
      {
        "id": "amira-kindergarten",
        "description": "in Syrien habe ich in Kindergarten gearbeitet mit kleine Kinder, ich liebe das",
        "selectedExperienceId": "job",
        "selectedExperienceLabel": "Job",
        "rating": 5
      },
      {
        "id": "amira-kurs",
        "description": "hier in Berlin habe ich Integrationskurs gemacht und B1 Sprachkurs",
        "selectedExperienceId": "school",
        "selectedExperienceLabel": "Schule",
        "rating": 4
      },
      {
        "id": "amira-schwester",
        "description": "ich passe auf meine Schwester auf wenn meine Mutter arbeitet",
        "selectedExperienceId": "home-help",
        "selectedExperienceLabel": "Zu Hause",
        "rating": 4
      }
    ],
    "selectedPracticalExperienceIds": ["amira-kindergarten", "amira-kurs", "amira-schwester"],
    "workPreferences": {
      "environment": "a",
      "hands-vs-mind": "a",
      "location": "a",
  ...
  -- tier_s: 3 entries (schulische helping-tier care cluster)
  ARRAY[
  ...
  -- tier_a: 9 entries (broad — direction-mismatch means several Joblinge-realistic adjacents)
  ARRAY[
    33212,  -- Medizinische/r Fachangestellte/r (A_anchor; screenWork=true held with incidental-clinical-entry carve-out)
    133617, -- Hauswirtschafter/in (C_smallReal)
  ...
  -- tier_c: 59 entries
  ARRAY[
    -- Access-floor / FHR gate (no Realschule path documented)
    132173, -- Pflegefachmann/-frau (Ausbildung)
    9162,   -- Erzieher/in
...
-- Criterion-first tier assignment: Tier S = 4 (core Bau-Handwerk), Tier C
-- names two trap-shapes (Schrauben→Kfz, Bauen→tech-drafting).
-- ────────────────────────────────────────────────────────────────────────
insert into personas (
  id,
  name,
  ...
  '{
    ...
    "customStrengths": ["wenn was kaputt ist mach ich das gleich — Schrank, Schlauch, alles selbst. Mein Stiefvater hat mir Pflastern und Beton mischen beigebracht. Bin gut darin."],
    "selectedCustomStrengths": ["wenn was kaputt ist mach ich das gleich — Schrank, Schlauch, alles selbst. Mein Stiefvater hat mir Pflastern und Beton mischen beigebracht. Bin gut darin."],
    "preferredJobs": [],
    "customWorkExpectations": [],
    "practicalExperiences": [
      {
        "id": "lukas-baustelle",
        "description": "Seit ich 14 bin helf ich meinem Stiefvater an Wochenenden auf der Baustelle — Tiefbau, Pflaster, Mauer setzen, Beton mischen.",
        "selectedExperienceId": "home-help",
        "selectedExperienceLabel": "Zu Hause",
        "rating": 5
      },
      {
        "id": "lukas-maler",
        "description": "In der 9. Klasse 2 Wochen Praktikum als Maler, fand ich gut, war aber etwas eintönig — Wand streichen ist nicht so spannend wie was richtig bauen.",
        "selectedExperienceId": "internship",
        "selectedExperienceLabel": "Praktikum",
        "rating": 3
      },
      {
        "id": "lukas-gruen",
        "description": "Letzten Sommer 400€-Job Grünflächenpflege beim Bezirksamt, Bäume schneiden und Wege pflastern.",
        "selectedExperienceId": "job",
        "selectedExperienceLabel": "Job",
        "rating": 4
      }
    ],
    "selectedPracticalExperienceIds": ["lukas-baustelle", "lukas-maler", "lukas-gruen"],
    "workPreferences": {
      "environment": "b",
      "location": "b",
      "hands-vs-mind": "a",
  ...
  -- tier_a: 16 entries (Bau-direction siblings + Ausbau-Handwerk + Bau-adjacent)
  ARRAY[
...
-- Criterion-first tier assignment: Tier S = 2 (KBM + VFA-Kommunal — the
-- criterion-cleanest), Tier C names three trap-shapes
-- (Mädchen-Realschule→Friseur, Planning→Veranstaltungskauf-Abi,
-- Realschule-creative-stereotype).
-- ────────────────────────────────────────────────────────────────────────
insert into personas (
  id,
  name,
  ...
  '{
    ...
    "customStrengths": ["ich bin sehr ordentlich. Termine planen, Excel-Tabellen führen, immer wissen wo was ist — das fällt mir leicht. Im Praktikum hat die Chefin gesagt sie würde mich sofort einstellen wenn ich Abschluss habe."],
    "selectedCustomStrengths": ["ich bin sehr ordentlich. Termine planen, Excel-Tabellen führen, immer wissen wo was ist — das fällt mir leicht. Im Praktikum hat die Chefin gesagt sie würde mich sofort einstellen wenn ich Abschluss habe."],
    "preferredJobs": [],
    "customWorkExpectations": [],
    "practicalExperiences": [
      {
        "id": "lara-bezirksamt",
        "description": "Schülerpraktikum 2 Wochen beim Bezirksamt Mitte — Verwaltung. Akten gemacht, Termine eingetragen, Telefon entgegengenommen, war genau mein Ding.",
        "selectedExperienceId": "internship",
        "selectedExperienceLabel": "Praktikum",
        "rating": 5
      },
      {
        "id": "lara-imbiss",
        "description": "Ich helfe meinem Vater seit 2 Jahren mit den Rechnungen für den Imbiss — Excel führen, Belege sortieren, Steuerberater-Ordner machen.",
        "selectedExperienceId": "home-help",
        "selectedExperienceLabel": "Zu Hause",
        "rating": 5
      }
    ],
    "selectedPracticalExperienceIds": ["lara-bezirksamt", "lara-imbiss"],
    "workPreferences": {
      "environment": "a",
      "location": "a",
      "hands-vs-mind": "b",
